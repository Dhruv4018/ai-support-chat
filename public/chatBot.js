...
(function () {
    ...
    const api_url = "https://ai-support-chat-dhruv-jain.vercel.app/api/chat"
    ...
    <div id="chat-input" style="display:flex; border-top:1px solid #e5e7eb; padding:8px gap:6px">
    <input type:"text 
    style= 
    "flex:1;
    padding:8px 10px;
